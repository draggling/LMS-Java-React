      ...
      <Modal isOpen={modal} toggle={toggle}>
        ...
        <ModalBody>
            ...
            <FormGroup>
              ...
              <Input type="text" name="branchName" id="formBranchName" defaultValue={currentBranchName} onChange={handleNameChange} />
            </FormGroup>

            <FormGroup>
              <Label for="formBranchAddress">BranchAddress</Label>
              <Input type="text" name="branchAddress" id="formBranchAddress" defaultValue={currentBranchAddress} onChange={handleAddressChange} />
            </FormGroup>

            </Form>
            <Button color="primary" className="twobuttons" onClick={() => {updateBranch(id, newBranchName, newBranchAddress)} }>Update</Button>
